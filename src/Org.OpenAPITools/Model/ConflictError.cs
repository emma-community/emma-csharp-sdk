...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ConflictError : IValidatableObject
    {
        /// <summary>
        ...
        public ConflictError(string code = default(string), string message = default(string))
        {
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for ConflictError and cannot be null");
            }
            this.Code = code;
        ...
        /// <example>Unable to update entity</example>
