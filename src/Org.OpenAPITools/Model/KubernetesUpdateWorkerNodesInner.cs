...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "KubernetesUpdate_workerNodes_inner")]
    public partial class KubernetesUpdateWorkerNodesInner : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KubernetesUpdateWorkerNodesInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KubernetesUpdateWorkerNodesInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KubernetesUpdateWorkerNodesInner" /> class.
        /// </summary>
        /// <param name="id">ID of the kubernetes worker node.</param>
        ...
        public KubernetesUpdateWorkerNodesInner(int id = default(int), string name = default(string), string dataCenterId = default(string), VCpuTypeEnum vCpuType = default(VCpuTypeEnum), int vCpu = default(int), int ramGb = default(int), VolumeTypeEnum volumeType = default(VolumeTypeEnum), int volumeGb = default(int))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for KubernetesUpdateWorkerNodesInner and cannot be null");
            }
            this.Name = name;
            // to ensure "dataCenterId" is required (not null)
            if (dataCenterId == null)
            {
                throw new ArgumentNullException("dataCenterId is a required property for KubernetesUpdateWorkerNodesInner and cannot be null");
            }
        ...
        /// </summary>
        /// <value>ID of the kubernetes worker node</value>
        /// <example>18</example>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KubernetesUpdateWorkerNodesInner {\n");
