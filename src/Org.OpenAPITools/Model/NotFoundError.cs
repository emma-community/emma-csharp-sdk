...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class NotFoundError : IValidatableObject
    {
        ...
        public NotFoundError(string code = default(string), string message = default(string))
        {
            ...
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for NotFoundError and cannot be null");
            }
            this.Code = code;
            // to ensure "message" is required (not null)
            if (message == null)
            {
                throw new ArgumentNullException("message is a required property for NotFoundError and cannot be null");
            }
