...
namespace Org.OpenAPITools.Model
{
    ...
    /// SpotCreate
    /// </summary>
    [DataContract(Name = "SpotCreate")]
    public partial class SpotCreate : IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Type of the Central Processing Units (vCPUs)</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SpotCreate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SpotCreate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SpotCreate" /> class.
        /// </summary>
        /// <param name="name">Name of the spot instance (required).</param>
        ...
        /// <param name="vCpuType">Type of the Central Processing Units (vCPUs) (required).</param>
        ...
        /// <param name="price">Offer price of the spot instance (required).</param>
        public SpotCreate(string name = default(string), string dataCenterId = default(string), int osId = default(int), CloudNetworkTypeEnum cloudNetworkType = default(CloudNetworkTypeEnum), VCpuTypeEnum vCpuType = default(VCpuTypeEnum), int vCpu = default(int), int ramGb = default(int), VolumeTypeEnum volumeType = default(VolumeTypeEnum), int volumeGb = default(int), int sshKeyId = default(int), int securityGroupId = default(int), decimal price = default(decimal))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for SpotCreate and cannot be null");
            }
            this.Name = name;
            // to ensure "dataCenterId" is required (not null)
            if (dataCenterId == null)
            {
                throw new ArgumentNullException("dataCenterId is a required property for SpotCreate and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Name of the spot instance</value>
        /// <example>spot-default</example>
        ...
        /// </summary>
        /// <value>Offer price of the spot instance</value>
        /// <example>0.002635</example>
